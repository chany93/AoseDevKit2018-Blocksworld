...
public class PddlStepUnstackAskHelp_intention extends Intention<PddlStep_goal> {
	
	@Override
	public boolean context(Agent a, PddlStep_goal g) {
		return g.action.equals("unstack") //pickup
	...
	public Next step0(IntentionInput in) {
		...
		PddlClause[] pddlGoal = { Blocksworld.sayHolding( nameOfAgentToAskForHelp, in.event.args[1] ) };
