...
import unitn.adk2018.blocksworld.message.ClauseHolding_intention;
...
public abstract class Exercise5Broadcast {
...
//		r2Agent.addSupportedEvent(Clause_msg.class, ClauseHolding_intention.class);
		...
		r2Agent.addSupportedEvent(PddlStep_goal.class, PddlStepWithPostCondition_intention.class);
		// Beliefs
		r2Agent.getBeliefs().declareObject( r1 );
		r2Agent.getBeliefs().declare( Blocksworld.sayMe(r1) );
		// Env
		 ...
		 */
		Environment.sendMessage ( new Sensing_msg( r1, env ) );
